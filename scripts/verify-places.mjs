...
const QUERY_OVERRIDES = {
  ...
  'stanford-campus': 'The Oval, Stanford, California',
  'stanford-dish': 'Stanford Dish',
  'baylands-preserve': 'Lucy Evans Baylands Nature Interpretive Center, Palo Alto',
  'edgewood-park': 'Edgewood County Park, Redwood City',
  'water-dog-lake': 'Water Dog Lake, Belmont',
  'eleanor-pardee-park': 'Eleanor Pardee Park, Palo Alto',
